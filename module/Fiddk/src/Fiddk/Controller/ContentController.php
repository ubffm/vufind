    ...
    public function contentAction()
    {
        ...
        if ($page == 'news') {
            if ($this->formWasSubmitted('submit')) {
                ...
                $recipient_email = $feedback->recipient_email ?? null;
                $recipient_name = $feedback->recipient_name ?? 'UB Frankfurt';
                $newsletter_subject = $feedback->newsletter_subject ?? 'Newsletter Subscription';
                $sender_email = $feedback->sender_email ?? 'redaktion@performing-arts.eu';
                $sender_name = $feedback->sender_name ?? 'Newsletter Subscription';
