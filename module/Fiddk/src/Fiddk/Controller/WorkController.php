<?php
/**
 * Work "Record" Controller (which is a Search Controller with Recommendation)
 *
 * PHP version 7
 *
 ...
 * @link     https://vufind.org Main Site
 */
class WorkController extends \VuFind\Controller\AbstractSearch
{
    ...
    public function homeAction()
    {
      ...
      $query->set('name', $name);
      return !empty($id) ?
        $this->forwardTo('Work', 'Results') : $this->forwardTo('Search', 'Home');
    }
    /**
