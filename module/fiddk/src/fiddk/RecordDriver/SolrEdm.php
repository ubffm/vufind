...
class SolrEdm extends \VuFind\RecordDriver\SolrDefault
{
    ...
    protected $agentRoles = ['dc:contributor' => true, 'dc:creator' => true, 'pro:author' => true, 'eclap:director' => true, 'eclap:actor' => true, 'eclap:setDesigner' => true, 'eclap:costumeDesigner' => true, 'eclap:performer' => true, 'eclap:choreographer' => true, 'eclap:dramaturge' => true, 'eclap:composer' => true, 'eclap:dancer' => true, 'gndo:photographer' => true, 'pro:illustrator' => true, 'bibo:editor' => true, 'bibo:recipient' => true];
  ...
  public function getParentFormats()
  {
    ...
    public function getSeeAlso()
    {
        ...
        if ($this->getChildRecordCount()) {
          $seeAlso['child_records'][] = [$this->getChildRecordCount()];
        }
    ...
    public function isArchiveRecord()
    {
        ...
        $bool = $this->searchService->search('Solr', $query, 0, 0, null)
             ->getTotal();
    ...
    public function getKVKLink() {
      ...
      if (!$exclude) {
        ...
        if ($isbn) {
          ...
          if (isset($this->getDatesPlaces("Published")[0]["dates"][0])) {
            $url = $url . "PY=" . $this->getDatesPlaces("Published")[0]["dates"][0] . "&";
          }
